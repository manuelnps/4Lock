...
uint8_t broadcastAddress[] = {0xa8, 0x42, 0xe3, 0xcd, 0x47, 0xb4};
// variáveis a enviar
float xi;
float yi;
...
void loop() {
  ...
  if (result == ESP_OK) {
    ...
    Serial.println("Error sending the data"); // FAZER ACKS PARA TENTAR ENVIAR A INFORMAÇÃO NOVAMENTE AQUI TAMBÉM!
  }
  delay(2000);
}
